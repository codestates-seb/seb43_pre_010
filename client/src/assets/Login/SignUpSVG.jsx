...
export const UnlockIcon = () => {
  return (
    ...
    >
      ...
      <path opacity=".5" d="M20.6 16H6.4l7.1 8 7-8zM15 25.3a2 2 0 01-3 0l-8.5-9.6a1 1 0 01.7-1.7h18.6a1 1 0 01.7 1.7L15 25.3z"/>
    </svg>
  );
};
...
export const TagsIcon = () => {
  return (
    ...
    >
      ...
      <path opacity=".5" d="M13 0a2 2 0 00-1.4.6l-10 10a2 2 0 000 2.8c.1-.2.3-.6.6-.8l10-10a2 2 0 011.4-.6h9.6a2 2 0 00-2-2H13z"/>
    </svg>
  );
};
