package tenten.StackOverflowClone.response;
...
public class ErrorResponse {
    ...
    public static class FieldError {
        ...
        public static List<FieldError> of(List<org.springframework.validation.FieldError> fieldErros) {
            return fieldErros.stream()
